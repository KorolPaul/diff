...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/UI/icon/assets/ChevronLeftIcon.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ChevronLeftIcon = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { ChevronLeftIcon as default };
//# sourceMappingURL=ChevronLeftIcon-DE1oG1Yo.mjs.map
